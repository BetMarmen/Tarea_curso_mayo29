...
public static void mostrar(ArrayList<cuenta> a,String tipo, String subtipo) {
	for(int i=0;i<a.size();i++) {
	if(a.get(i).getTipo().equals(tipo) & a.get(i).getSuptipo().equals(subtipo))System.out.println(a.get(i).toString());;
	}
